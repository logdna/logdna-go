...
Copyright © LogDNA, released under an MIT license. See the [LICENSE](https://github.com/logdna/logdna-go/blob/master/LICENSE) file and https://opensource.org/licenses/MIT
